(function(){
  ...
  function addWorksheetIdentity(){
    ...
    if(track&&!document.getElementById('school-page-tracking')){
      var t=document.createElement('div');t.id='school-page-tracking';t.className='school-page-tracking';t.setAttribute('aria-label','Repeated worksheet Tracking number');t.textContent='Tracking #: '+track;document.body.appendChild(t);
